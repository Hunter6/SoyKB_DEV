...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    if([[segue identifier] isEqualToString:@"ShowSecondNav"]){
        SecondNavTableViewController *secoundnavtableviewcontroller = [segue destinationViewController];
        
        NSIndexPath *myIndexPath = [self.tableView indexPathForSelectedRow];
        int row = [myIndexPath row];
        secoundnavtableviewcontroller.BarDetail = @[_Title[row]];
    }
}
